    ...
    $path = "images/".$nama_file;
        ...
        if($ukuran_file <= 1000000){ 
          ...
          if(move_uploaded_file($tmp_file, $path)){ 
            ...
            $sql = mysqli_query($koneksi,"insert into gambar set tanggal_upload='$tanggal_upload', uploader='$uploader',nama='$nama_file', ukuran='$ukuran_file'");
            //jika insert data berhasil, maka akan dikembalikan ke halaman tampilgambar.php
            if($sql){ 
              header("location:penghubung.php?nav=tampilgambar"); 
            }else{
