 ...
 alt="bni.png" align="right" style="width:200px;height:200px"></p>
					...
					<div class="card m-b-15">
						...
						<form method="POST">
							...
							<label for="exampleInputName">Nomor : W04/12.3/</label><input type="text" style="width:70px" name="nomor_surat" value="<?php echo $nomor_surat;?>" />
                     ...
                     <u>DIVISI OPERASIONAL TEKNOLOGI INFORMASI</u> </br>
					      ...
					      <div class="form-group">
							...
							<input type="text" name="hal" value="<?php echo $hal;?>" style="width:150px">
                          ...
                          <table width="100%" cellspacing="0" cellpadding="0" border="1" style="border-collapse:collapse">
                                  <tr>
                                    ...
                                    <td width="50"><div align="center"><strong>Jarkom</strong></div></td>
...
<?php echo $i10;?>     
                                    ...
                                    <td align="center" width="100"><?php echo $i11;?>
                                  ...
                                  <tr>
                                    ...
                                    <td align="center" width="100"><?php echo $i17;?>
                                  ...
                                  <tr>
                                    ...
                                    <td align="center" width="100"><?php echo $i23;?>
                                  ...
                                  <tr>
                                    ...
                                    <td align="center" width="100"><?php echo $i29;?>
...
<strong><br />
                ...
                <strong>KANTOR WILAYAH 04</strong> </p>
                          ...
                          <p><br />
                            ...
                            <u><strong><?php echo $nama;?></strong></u><br />
                          <strong><?php echo $jabatan;?></strong>						  </p>
