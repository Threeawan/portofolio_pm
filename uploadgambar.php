...
if(isset($_POST['upload'])){
	$sql = mysqli_query($koneksi, "insert into gambar (tanggal_upload, uploader)values('".$_POST['tanggal_upload']."', '".$_POST['uploader']."')");	
	
?>
<script>alert('Foto Berhasil Diupload')</script>
<script>window.location='penghubung.php?nav=tampilgambar'</script>
<?php
}
?>
...
<div class="card m-b-15">
						...
						<div class="card-header card-header-inverse">
						  <h4 class="card-header-title">Upload Foto PM</h4>
						...
						<div class="card-body">
							...
							<form method="POST" enctype="multipart/form-data" action="uploadproses.php" >
								...
								<div class="form-group">
									...
									<input type="file" id="demo-hor-inputemail" class="form-control" name="gambar">
								</div>
