...
if(isset($_POST['hapus'])){
	$query = mysqli_query($koneksi, "delete from tandaterimabarang where id='".$_GET['id']."'");
?>
<script>alert('Data Berhasil Dihapus')</script>
<script>window.location='?nav=tandaterimabarangdata'</script>
<?php
}
?>
...
<div class="col-lg-12">
					...
					<div class="card m-b-15">
						<!-- BEGIN card-header -->
						<div class="card-header card-header-inverse"><strong>HAPUS TANDA-TERIMA PENYERAHAN BARANG</strong></div>
						<!-- END card-header -->
						<!-- BEGIN card-body -->
						<div class="card-body">
						  <form method="POST">
								...
								<div class="form-group">
									...
									<input type="date" class="form-control" id="exampleInputDate" name="tanggal" readonly="readonly" value="<?php echo $tanggal;?>">
								</div>
  Telah diserahkan sejumlah hardware/peralatan kepada :
                                <div class="form-group">
									<label for="exampleInputName">Cabang</label>
									<input type="text" class="form-control" id="exampleInputName" name="cabang" readonly="readonly" value="<?php echo $cabang;?>">
								</div>
								
								<div class="form-group">
									<label for="exampleInputDate">Alamat</label>
									<input type="text" class="form-control" id="alamat" name="alamat" readonly="readonly" value="<?php echo $alamat;?>">
								</div>
