...
<div class="col-lg-12">
					...
					<div class="card m-b-15">
						...
						<div class="form-group">
							...
							<br />
                            <a href="printpsk.php?id=<?php echo $_GET['id']; ?>" target="_blank" class="btn btn-warning"><i class="fas fa-sm fa-fw m-r-10 fa-pen-alt"></i>Lihat</a>
                            <a href="hasilpsk.php?id=<?php echo $_GET['id']; ?>" target="_blank" class="btn btn-success"><i class="fas fa-sm fa-fw m-r-10 fa-pencil-alt"></i>Hasil</a>
							<a href="?nav=powersystemdata" class="btn btn-primary"><i class="fas fa-sm fa-fw m-r-10 fa-undo-alt"></i>Kembali</a>  
