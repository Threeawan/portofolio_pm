...
if(isset($_POST['hapus'])){
	$query = mysqli_query($koneksi, "delete from pmclient where id='".$_GET['id']."'");
?>
<script>alert('Data Berhasil Dihapus')</script>
<script>window.location='?nav=pcclientdata'</script>
<?php
}
?>
...
<div class="col-lg-12">
					...
					<div class="card m-b-15">
						<!-- BEGIN card-header -->
						<div class="card-header card-header-inverse"><strong>HAPUS CHECKLIST PC CLIENT</strong></div>
						<!-- END card-header -->
						<!-- BEGIN card-body -->
						<div class="card-body">
						  <form method="POST">
