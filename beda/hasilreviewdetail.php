...
?>
            ...
            $tampil = mysqli_query($koneksi,"select * from review");
						  ...
						  <form method="POST" enctype="multipart/form-data">
							<div class="form-group">
                                ...
                                <table cellspacing="0" cellpadding="0" border="1" style="border-collapse:collapse" class="table table-responsive">
                                  ...
                                  <td>
                                    <input type="text" name="h1a" size="10"  value="<?php echo $h1a;?>" readonly="readonly"/></td>
                                  </tr>
                                  ...
                                  <tr>
                                    ...
                                    <td>Genset</td>
                                    <td> <input type="text" name="h1b" value="<?php echo $h1b;?>" readonly="readonly"></td>
                                  </tr>
                                  <tr>
...
Isi komentar:<br/>  
 ...
 <textarea rows="5" cols="50" name="komentar" value="<?php echo $komentar;?>" readonly="readonly"></textarea><br/>  
							    ...
							    <p><br />
							            <a href="printreview.php?id=<?php echo $_GET['id']; ?>" target="_blank" class="btn btn-warning"><i class="fas fa-sm fa-fw m-r-10 fa-pen-alt"></i>Lihat</a>
							            <a href="hasilreview.php?id=<?php echo $_GET['id']; ?>" target="_blank" class="btn btn-success"><i class="fas fa-sm fa-fw m-r-10 fa-pencil-alt"></i>Hasil</a>
							            <a href="?nav=hasilreviewdata" class="btn btn-primary"><i class="fas fa-sm fa-fw m-r-10 fa-undo-alt"></i>Kembali</a>					                  </p>
						  </form>
						</div>
						<!-- END card-body -->
					</div>
