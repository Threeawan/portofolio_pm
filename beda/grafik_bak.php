<?php
if(isset($_POST['ubah'])){
	mysqli_query($koneksi, "update grafik_bak set nilai='".$_POST['januari']."' where bulan='Januari'");
	mysqli_query($koneksi, "update grafik_bak set nilai='".$_POST['februari']."' where bulan='Februari'");
	mysqli_query($koneksi, "update grafik_bak set nilai='".$_POST['maret']."' where bulan='Maret'");
	mysqli_query($koneksi, "update grafik_bak set nilai='".$_POST['april']."' where bulan='April'");
	mysqli_query($koneksi, "update grafik_bak set nilai='".$_POST['mei']."' where bulan='Mei'");
	mysqli_query($koneksi, "update grafik_bak set nilai='".$_POST['juni']."' where bulan='Juni'");
	mysqli_query($koneksi, "update grafik_bak set nilai='".$_POST['juli']."' where bulan='Juli'");
	mysqli_query($koneksi, "update grafik_bak set nilai='".$_POST['agustus']."' where bulan='Agustus'");
	mysqli_query($koneksi, "update grafik_bak set nilai='".$_POST['september']."' where bulan='September'");
	mysqli_query($koneksi, "update grafik_bak set nilai='".$_POST['oktober']."' where bulan='Oktober'");
	mysqli_query($koneksi, "update grafik_bak set nilai='".$_POST['november']."' where bulan='November'");
	mysqli_query($koneksi, "update grafik_bak set nilai='".$_POST['desember']."' where bulan='Desember'");
		
?>
<script>alert("Data Berhasil Simpan");</script>
<script>window.location='penghubung.php?nav=grafikbatang'</script>
<?php
}
?>
...
<div class="col-lg-11">
					...
					<div class="card m-b-15">
						...
						<div class="card-header card-header-inverse">
							<h4 class="card-header-title">Input Skala BAK</h4>
