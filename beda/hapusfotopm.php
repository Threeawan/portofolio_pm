...
if(isset($_POST['hapus'])){
	$query = mysqli_query($koneksi, "delete from gambar where id='".$_GET['id']."'");	
...
<?php
$query = mysqli_query($koneksi, "select tanggal_upload, uploader, nama, ukuran from gambar where id='".$_GET['id']."'");
