...
if(isset($_POST['hapus'])){
	$query = mysqli_query($koneksi, "delete from penilaian where id='".$_GET['id']."'");
?>
<script>alert('Data Berhasil Dihapus')</script>
<script>window.location='?nav=penilaiandata'</script>
<?php
}
?>
...
<div class="col-lg-12">
					...
					<div class="card m-b-15">
						<!-- BEGIN card-header -->
						<div class="card-header card-header-inverse"><strong>HAPUS PENILAIAN TERHADAP KUALITAS UNIT TNR WILAYAH 04</strong></div>
						<!-- END card-header -->
						<!-- BEGIN card-body -->
					...
					<div class="card m-b-15">
						...
						<div class="card-body"><form method="POST">
						  <div class="form-group">
									...
									<input type="month" class="form-control" id="exampleInputName" name="periode_awal" value="<?php echo $periode_awal;?>" readonly="readonly">
								</div>
								<div class="form-group">
									<label for="exampleInputPassword1">Periode Akhir</label>
									<input type="month" class="form-control" id="exampleInputName" name="periode_akhir" value="<?php echo $periode_akhir;?>" readonly="readonly">
								</div>
						  ...
						  <center>
                            <table cellspacing="0" cellpadding="0" width="100%">
                              ...
                              <tr>
                                ...
                                <td colspan="7"><div align="center"><em><br />(mohon    mengisi saran/masukan/feedback)</em></div></td>
                              </tr>
                            </table>
                               <br />
