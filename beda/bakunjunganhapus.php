...
if(isset($_POST['hapus'])){
	$query = mysqli_query($koneksi, "delete from bakunjungan where id='".$_GET['id']."'");
?>
<script>alert('Data Berhasil Dihapus')</script>
<script>window.location='?nav=bakunjungandata'</script>
<?php
}
?>
...
<div class="col-lg-12">
					...
					<div class="card m-b-15">
						<!-- BEGIN card-header -->
						<div class="card-header card-header-inverse"><strong>HAPUS BERITA ACARA KUNJUNGAN/SUPERVISI/MAINTENANCE </strong></div>
						<!-- END card-header -->
						<!-- BEGIN card-body -->
						...
						<div class="card-body"><form method="POST">
						 	<div class="form-group">
                                ...
                                <div class="form-group">
								  ...
								  <input type="text" class="form-control" id="exampleInputName" name="" readonly="readonly" value="<?php echo $cabang;?>">
								</div>
								
								
								<div class="form-group">
								  <label for="exampleInputName">Alamat</label>
								  <input type="text" class="form-control" id="exampleInputName" name="" readonly="readonly" value="<?php echo $alamat;?>">
								</div>
                                
								<div class="form-group">
								  <label for="exampleInputName">Inputer</label>
								  <input type="text" class="form-control" id="exampleInputName" name="" readonly="readonly" value="<?php echo $inputer;?>">
								</div>
