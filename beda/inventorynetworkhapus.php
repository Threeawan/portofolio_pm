...
if(isset($_POST['hapus'])){
	$query = mysqli_query($koneksi, "delete from inventorynetwork where id='".$_GET['id']."'");
?>
...
<div class="col-lg-12">
					...
					<div class="card m-b-15">
						<!-- BEGIN card-header -->
						<div class="card-header card-header-inverse"><strong>HAPUS CHECKLIST INVENTORY NETWORK</strong></div>
						<!-- END card-header -->
						<!-- BEGIN card-body -->
						<div class="card-body">
						  <form method="POST">
                            ...
                            <p><br />
                            <strong>Switches Summary</strong></p>
                            <table width="100%" cellspacing="0" cellpadding="0" border="1">
                              <tr>
						...
						<a href="?nav=inventorynetworkdata" name="kembali" class="btn btn-warning">Kembali</a>
						  </form>
						</div>
						<!-- END card-body -->
					</div>
