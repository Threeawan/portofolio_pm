...
if(isset($_POST['hapus'])){
	$query = mysqli_query($koneksi, "delete from komunikasi where id='".$_GET['id']."'");
?>
<script>alert('Data Berhasil Dihapus')</script>
<script>window.location='?nav=komunikasidata'</script>
<?php
}
?>
...
<div class="col-lg-12">
					...
					<div class="card m-b-15">
						<!-- BEGIN card-header -->
						<div class="card-header card-header-inverse"><strong>HAPUS CHECKLIST KOMUNIKASI</strong></div>
						<!-- END card-header -->
						<!-- BEGIN card-body -->
							  ...
							  <div class="form-group">
                                ...
                                <tr>
                                  ...
                                  <tr>
                                    ...
                                    <td><select name="i19">
                                      <option value="<?php echo $i19;?>"></option>
