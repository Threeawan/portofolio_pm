...
<?php
if(isset($_POST['ubah'])){
	$query = mysqli_query($koneksi, "update surat_tugas set nama='".$_POST['nama']."', pangkat='".$_POST['pangkat']."', bepergian='".$_POST['bepergian']."', tanggal_berangkat='".$_POST['tanggal_berangkat']."', tanggal_kembali='".$_POST['tanggal_kembali']."', kendaraan='".$_POST['kendaraan']."', lain_lain='".$_POST['lain_lain']."', nomor_surat='".$_POST['nomor_surat']."', a1='".$_POST['a1']."', a2='".$_POST['a2']."', a3='".$_POST['a3']."', a4='".$_POST['a4']."', a5='".$_POST['a5']."', a6='".$_POST['a6']."', name='".$_POST['name']."', jabatan='".$_POST['jabatan']."'  where id='".$_GET['id']."'");
?>
<script>alert('Surat Tugas Berhasil Diubah')</script>
...
<div class="col-lg-12">
					...
					<div class="card m-b-15">
						...
						<div class="card-header card-header-inverse">
						  <div align="center"><strong>UBAH SURAT TUGAS</strong></div>
						</div>
						<!-- END card-header -->
						<!-- BEGIN card-body -->
                          ...
                          <div class="form-group">
							...
							<center>
							  ...
							  <p>
							    ...
							    <input type="text" style="width:50px" name="nomor_surat" value="<?php echo $nomor_surat;?>" />
							  </p>
							</center>
							<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
							  <tr>
							    ...
							    <td><div align=""><input type="text" style="width:200px" name="nama" value="<?php echo $nama;?>"/></div>
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
							  <tr>
							    ...
							    <td><div align="">
							      <input type="text" style="width:200px" name="pangkat" value="<?php echo $pangkat;?>" />
							      </div></td>
						      </tr>
						    </table>
							<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
							  <tr>
							    ...
							    <td><div align="">
							      <input type="text" style="width:200px" name="bepergian" value="<?php echo $bepergian;?>"  />
							      </div></td>
						      </tr>
						    </table>
							<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
							  <tr>
							    ...
							    <td><div align="">
							      <input type="date" style="width:150px" name="tanggal_berangkat" value="<?php echo $tanggal_berangkat;?>"/>
							      </div></td>
						      </tr>
						    </table>
							<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
							  <tr>
							    ...
							    <td><div align="">
							     ...
							     <input type="date" style="width:150px" name="tanggal_kembali" value="<?php echo $tanggal_kembali;?>" /> </div></td>
						      </tr>
						    </table>
							<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
							  <tr>
							    ...
							    <td><div align="">
							      Dinas/Sopir <input type="text" style="width:100px" name="kendaraan" value="<?php echo $kendaraan;?>" />
							      </div></td>
						      </tr>
						    </table>
							<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
                  ...
                  <br />  Jl. Perintis Kemerdekaan No. 3 Bandung
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
							  <tr>
							    ...
							    <td><div align="">
							      <input type="text" style="width:200px" name="lain_lain" value="<?php echo $lain_lain;?>" />
							      </div></td>
						      </tr>
						    </table>
							<p>&nbsp;</p>
							<p>Untuk melaksanakan perjanalan dinas ke <input type="text" style="width:100px" value="<?php echo $bepergian;?>" />
							  <br />
...
<div class="signature" style=''>
 ...
 <br />(<input type="text" style="width:200px" value="<?php echo $nama;?>"/>)</div></td>
 ...
 <canvas id="signature-pad2" class="signature-pad" width="200px" height="100px"></canvas>
						    ...
						    <table width="100%" border="1" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
							    ...
							    <tr>
							      <td align="center"><input type="date" name="a1" style="width:150px" value="<?php echo $a1;?>" /></td>
                                   
							      <td align="center"><input type="text" name="a2" value="<?php echo $a2;?>"   /></td>
                                  <td align="center"><input type="text" name="a3" value="<?php echo $a3;?>" /></td>
                                  <td align="center"><input type="text" name="a4" value="<?php echo $a4;?>"  /></td>
                                  <td align="center"><input type="text" name="a5" value="<?php echo $a5;?>"  /></td>
                                  <td align="center"><input type="text" name="a6" value="<?php echo $a6;?>"  /></td>
