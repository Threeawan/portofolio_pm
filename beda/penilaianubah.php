...
<?php
if(isset($_POST['ubah'])){
	 $sql = "update penilaian set periode_awal='".$_POST['periode_awal']."', periode_akhir='".$_POST['periode_akhir']."', i1='".$_POST['i1']."', i2='".$_POST['i2']."', i3='".$_POST['i3']."', i4='".$_POST['i4']."', i5='".$_POST['i5']."', i6='".$_POST['i6']."', i7='".$_POST['i7']."', i8='".$_POST['i8']."', i9='".$_POST['i9']."', i10='".$_POST['i10']."', saran='".$_POST['saran']."'                                      where id='".$_GET['id']."'";
...
<div class="col-lg-12">
					...
					<div class="card m-b-15">
						<!-- BEGIN card-header -->
						<div class="card-header card-header-inverse"><strong>UBAH PENILAIAN TERHADAP KUALITAS UNIT TNR WILAYAH 04</strong></div>
						<!-- END card-header -->
						<!-- BEGIN card-body -->
					...
					<div class="card m-b-15">
						...
						<div class="card-body"><form method="POST">
						 <div class="form-group">
									...
									<input type="month" class="form-control" id="exampleInputName" name="periode_awal" value="<?php echo $periode_awal;?>" ="">
								</div>
								<div class="form-group">
									<label for="exampleInputPassword1">Periode Akhir</label>
									<input type="month" class="form-control" id="exampleInputName" name="periode_akhir" value="<?php echo $periode_akhir;?>" ="">
								</div>
						  ...
						  <center>
                            <table cellspacing="0" cellpadding="0" width="100%">
                              ...
                              <tr>
                                <td colspan="7"><div align="center"><br /><em>(mohon mengisi saran/masukan/feedback)</em></div></td>
                              </tr>
                            </table>
                               <br />
                            <table width="100%" height="219" border="1">
                              <tr>
                                <td width="100%"><textarea name="saran" style="width:100%;height:100%"><?php echo $saran; ?></textarea></td>
                              </tr>
                            </table>
                            <br />
                            </center>
				<button type="submit" name="ubah" class="btn btn-info">Ubah</button>
				<a href="?nav=penilaiandata" name="kembali" class="btn btn-warning">Kembali</a>
						  </form>
