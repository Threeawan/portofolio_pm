...
<div class="col-lg-12">
					...
					<div class="card m-b-15">
						...
						<div class="card-header card-header-inverse">
						  <div align="center"><strong>SURAT TUGAS</strong></div>
						</div>
						<!-- END card-header -->
						<!-- BEGIN card-body -->
...
<div class="signature" style=''>
 ...
 <canvas id="signature-pad2" class="signature-pad" width="200px" height="100px"></canvas>
                                    ...
                                    <p><strong><u><input type="text" style="width:100px" name="name" value="<?php echo $name;?>"></u><br /><input type="text" name="jabatan" style="width:150px" value="<?php echo $jabatan;?>"></strong></p>
                                    <p>&nbsp;</p></td>
...
<a href="printsurattugas.php?id=<?php echo $_GET['id'];?>" target="_blank" class="btn btn-warning"><i class="fas fa-sm fa-fw m-r-10 fa-pen-alt"></i>Cetak</a>
							 <a href="?nav=surat_tugas_data" class="btn btn-info"><i class="fas fa-sm fa-fw m-r-10 fa-undo-alt"></i>Kembali</a>
						  </form>
