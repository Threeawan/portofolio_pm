...
if(isset($_POST['hapus'])){
	$query = mysqli_query($koneksi, "delete from serverhardware where id='".$_GET['id']."'");
?>
...
<div class="col-lg-12">
					...
					<div class="card m-b-15">
						<!-- BEGIN card-header -->
						<div class="card-header card-header-inverse"><strong> HAPUS CHECKLIST SERVER  HARDWARE</strong></div>
						<!-- END card-header -->
						<!-- BEGIN card-body -->
						<div class="card-body">
						  <form method="POST">
