...
if(isset($_POST['hapus'])){
	$query = mysqli_query($koneksi, "delete from surat where id='".$_GET['id']."'");
?>
...
<div class="col-lg-12">
					...
					<div class="card m-b-15">
						...
						<div class="card-header card-header-inverse">
						  <div align="center"><strong>HAPUS SURAT</strong></div>
						</div>
						<!-- END card-header -->
						<!-- BEGIN card-body -->
					...
					<div class="card m-b-15">
                     ...
                     <u>DIVISI OPERASIONAL TEKNOLOGI INFORMASI</u> </br>
					      ...
					      <div class="form-group">
							...
							<input type="text" name="hal" value="<?php echo $hal;?>" readonly="readonly" style="width:150px">
